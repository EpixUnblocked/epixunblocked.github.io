var unityFramework = (() => {
    ...
    function(unityFramework={}) {
        ...
        function _AudioInputStreamClose() {}
        function _AudioInputStreamGetClientID() {}
        function _AudioInputStreamGetStreamID() {}
        function _AudioInputStreamSendQueuedMessages() {}
        function _AudioInputStreamSendRawAudioData() {}
        function _AudioOutputStreamGetAudioData() {}
        function _AudioOutputStreamGetChannels() {}
        function _AudioOutputStreamGetClientID() {}
        function _AudioOutputStreamGetIsOpen() {}
        function _AudioOutputStreamGetSampleRate() {}
        function _AudioOutputStreamGetStreamID() {}
        function _AudioOutputStreamSetSampleRate() {}
        function _AudioPreprocessorCreate() {}
        function _AudioPreprocessorDelete() {}
        function _AudioPreprocessorProcessPlaybackFrame() {}
        function _AudioPreprocessorProcessRecordFrame() {}
        function _CheckPluginVersion() {}
        function _ClientBumpAutoDisconnectTime() {}
        function _ClientConnect() {}
        function _ClientCreate() {}
        function _ClientCreateAudioInputStream() {}
        function _ClientDelete() {}
        function _ClientDeleteAudioInputStream() {}
        function _ClientDeleteAudioOutputStream() {}
        function _ClientDisconnect() {}
        function _ClientGetClientID() {}
        function _ClientGetPing() {}
        function _ClientGetRoomTime() {}
        function _ClientGetState() {}
        function _ClientReceiveIncomingAudioStreamEvent() {}
        function _ClientReceiveIncomingPersistenceMessage() {}
        function _ClientReceiveIncomingPersistenceMessageData() {}
        function _ClientReceiveIncomingRPCMessage() {}
        function _ClientReceiveIncomingRPCMessageData() {}
        function _ClientSendPersistenceMessage() {}
        function _ClientSendRPCMessage() {}
        function _ClientSetProfilingEnabled() {}
        function _ClientSetUpNetworkStack() {}
        function _ClientStartConnection() {}
        function _ClientTearDownNetworkStack() {}
        function _ClientTryGetProfilingSample() {}
        ...
        function JS_GravitySensor_eventHandler() {
            if (JS_GravitySensor_callback != 0)
                getWasmTableEntry(JS_GravitySensor_callback)(JS_GravitySensor.x * JS_Accelerometer_multiplier, JS_GravitySensor.y * JS_Accelerometer_multiplier, JS_GravitySensor.z * JS_Accelerometer_multiplier)
        }
        ...
        function JS_ScreenOrientation_eventHandler() {
            if (JS_ScreenOrientation_callback)
                getWasmTableEntry(JS_ScreenOrientation_callback)(window.innerWidth, window.innerHeight, screen.orientation ? screen.orientation.angle : window.orientation)
        }
        ...
        function _MatcherClearRequest() {}
        function _MatcherConnect() {}
        function _MatcherConnectToRoom() {}
        function _MatcherCreate() {}
        function _MatcherDelete() {}
        function _MatcherDisconnect() {}
        function _MatcherGetConnectToRoomRequestClustersToPingAddressAtIndex() {}
        function _MatcherGetConnectToRoomRequestClustersToPingCount() {}
        function _MatcherGetConnectToRoomRequestClustersToPingNameAtIndex() {}
        function _MatcherGetConnectToRoomRequestFoundRoomResponse() {}
        function _MatcherGetConnectToRoomRequestResponseType() {}
        function _MatcherGetRequestErrorMessage() {}
        function _MatcherGetRequestFailMessage() {}
        function _MatcherGetRequestState() {}
        function _MatcherTick() {}
        function _MicrophoneCreate() {}
        function _MicrophoneDelete() {}
        function _MicrophoneGetAudioData() {}
        function _MicrophoneGetChannels() {}
        function _MicrophoneGetSampleRate() {}
        function _MicrophonePlatformSupported() {}
        function _MicrophoneStart() {}
        function _MicrophoneStop() {}
        function _SetLogFunction() {}
        var webSocketState = {
            instances: {},
            lastId: 0,
            onOpen: null,
            ...
            var Validate = function() {
                ...
                _createClass(Validate, null, [{
                    ...
                    value: function property(requestData, propertyName, typeName) {
                        ...
                        if (_typeof(propertyValue) != typeName)
                            throw new Error("Missing or invalid ".concat(propertyName, " property. (").concat(propertyValue, " of type (").concat(_typeof(propertyValue), ") (requestData: ").concat(requestData, ")"))
                    }
                }]);
                return Validate
            }();
            var BidirectionalInternal = function() {
                ...
                _createClass(BidirectionalInternal, null, [{
                    ...
                    value: function validateRequestMessage(message) {
                        if (message == null)
                            throw new Error("Request message is null");
                        if (message.requestGUID == null)
                            throw new Error("Request guid property is null");
                        if (message.requestType == null)
                            throw new Error("Request type property is null");
                        if (message.requestData == null)
                            throw new Error("Request data property is null");
                        Validate.property(message, "requestGUID", "string");
                        Validate.property(message, "requestType", "string");
                        if (message.requestGUID == "")
                            throw new Error("Request guid is empty");
                        if (message.requestType == "")
                            throw new Error("Request type is empty")
                    }
                }, {
                    key: "validateRequestResponseMessage",
                    value: function validateRequestResponseMessage(message) {
                        if (message == null)
                            throw new Error("Request response message is null");
                        if (message.requestGUID == null)
                            throw new Error("Request response guid property is null");
                        if (message.status == null)
                            throw new Error("Request response status property is null");
                        Validate.property(message, "requestGUID", "string");
                        Validate.property(message, "status", "string");
                        if (message.requestGUID == "")
                            throw new Error("Request response guid is empty");
                        if (message.status != "success" && message.status != "error")
                            throw new Error("Request response status is invalid");
                        if (message.status == "success" && message.responseData == null)
                            throw new Error("Request response is successful but has no responseData")
                    }
                }]);
                ...
                var Request = function() {
                    ...
                    _createClass(Request, [{
                        ...
                        value: function resolveSuccess(responseData) {
                            ...
                            if (this._promiseResolve != undefined)
                                this._promiseResolve(responseData)
                        }
                    }, {
                        key: "rejectError",
                        value: function rejectError(errorMessage) {
                            ...
                            if (this._promiseReject != undefined)
                                this._promiseReject(errorMessage)
                        }
                    }, {
                        key: "rejectFail",
                        value: function rejectFail(failMessage) {
                            ...
                            if (this._promiseReject != undefined)
                                this._promiseReject(failMessage)
                        }
                    }, {
                        key: "promise",
                        get: function get() {
            ...
            var BidirectionalClient = function() {
                ...
                _createClass(BidirectionalClient, [{
                    ...
                    value: function sendRequest(requestType, requestData, timeout) {
                        ...
                        if (this.connected)
                            this.sendRequestIfNeeded(request);
                        return request
                    }
                }, {
                        ...
                        onClientRequestPromise.then(function(responseData) {
                            ...
                            try {
                                if (error.context != null)
                                    message.errorContext = JSON.stringify(error.context)
                            } catch (_unused) {
            ...
            var Matcher = function() {
                ...
                _createClass(Matcher, [{
                    ...
                    value: function clearRequest(requestGUID) {
                        if (!this._requests["delete"](requestGUID))
                            Debug.error("Matcher: ClearRequest called, but request GUID does not exist or was aleady removed. (".concat(requestGUID, ")"))
                    }
                }, {
                    key: "connectToRoom",
                    value: function connectToRoom(requestType, appKey, appMetadataJSONString, roomName, roomServerOptionsJSONString, clientOffer, webhookContext) {
                        ...
                        if (webhookContext != null)
                            requestData["webhookContext"] = webhookContext;
                        if (roomServerOptionsJSONString != null)
                            requestData["roomServerOptions"] = JSON.parse(roomServerOptionsJSONString);
                        var request = this._client.sendRequest(requestType, requestData, 120);
                    ...
                    value: function connectToMediaRoom(appKey, roomName) {
                        ...
                        var request = this._client.sendRequest("ConnectToMediaRoom", requestData, 120);
                        var requestGUID = request.guid;
                        this._requests.set(requestGUID, request);
                        return requestGUID
                    }
            ...
            var DatastoreClient = function() {
                ...
                _createClass(DatastoreClient, [{
                    ...
                    value: function sendDatastoreMessage(datastoreMessage, reliable) {
                        if (reliable)
                            this._datastoreReliableChannel.send(datastoreMessage);
                        else
                            this._datastoreUnreliableChannel.send(datastoreMessage)
                    }
                }, {
                    key: "receiveIncomingDatastoreMessage",
                    value: function receiveIncomingDatastoreMessage() {
                        if (this._datastoreMessages.length <= 0)
                            return null;
                        ...
                        case 0:
                            {
                                ...
                                mv.setUint8(0, 1);
                                mv.setUint8(1, 0);
                                mv.setFloat64(2, 0, true);
                                this._serverReliableChannel.send(m);
                                break
                            }case 1:
                            {
                                var pingMilliseconds = performance.now() - this._clockSyncSendTime;
                                var roomTimeMilliseconds = messageBufferView.getFloat64(2, true) * 1e3;
                                var roomTimeMillisecondsPingAdjusted = roomTimeMilliseconds + pingMilliseconds / 2;
                    ...
                    key: "roomTime",
                    get: function get() {
                        return (performance.now() + this._roomClockOffset) / 1e3
                    }
                }], [{
                    ...
                    value: function ConvertDataChannelSettings(reliable, ordered) {
                        ...
                        if (!reliable)
                            dataChannelSettings.maxRetransmits = 0;
        ...
        var wasmImports = {
            "AudioInputStreamClose": _AudioInputStreamClose,
            "AudioInputStreamGetClientID": _AudioInputStreamGetClientID,
            "AudioInputStreamGetStreamID": _AudioInputStreamGetStreamID,
            "AudioInputStreamSendQueuedMessages": _AudioInputStreamSendQueuedMessages,
            "AudioInputStreamSendRawAudioData": _AudioInputStreamSendRawAudioData,
            "AudioOutputStreamGetAudioData": _AudioOutputStreamGetAudioData,
            "AudioOutputStreamGetChannels": _AudioOutputStreamGetChannels,
            "AudioOutputStreamGetClientID": _AudioOutputStreamGetClientID,
            "AudioOutputStreamGetIsOpen": _AudioOutputStreamGetIsOpen,
            "AudioOutputStreamGetSampleRate": _AudioOutputStreamGetSampleRate,
            "AudioOutputStreamGetStreamID": _AudioOutputStreamGetStreamID,
            "AudioOutputStreamSetSampleRate": _AudioOutputStreamSetSampleRate,
            "AudioPreprocessorCreate": _AudioPreprocessorCreate,
            "AudioPreprocessorDelete": _AudioPreprocessorDelete,
            "AudioPreprocessorProcessPlaybackFrame": _AudioPreprocessorProcessPlaybackFrame,
            "AudioPreprocessorProcessRecordFrame": _AudioPreprocessorProcessRecordFrame,
            "CheckPluginVersion": _CheckPluginVersion,
            "ClientBumpAutoDisconnectTime": _ClientBumpAutoDisconnectTime,
            "ClientConnect": _ClientConnect,
            "ClientCreate": _ClientCreate,
            "ClientCreateAudioInputStream": _ClientCreateAudioInputStream,
            "ClientDelete": _ClientDelete,
            "ClientDeleteAudioInputStream": _ClientDeleteAudioInputStream,
            "ClientDeleteAudioOutputStream": _ClientDeleteAudioOutputStream,
            "ClientDisconnect": _ClientDisconnect,
            "ClientGetClientID": _ClientGetClientID,
            "ClientGetPing": _ClientGetPing,
            "ClientGetRoomTime": _ClientGetRoomTime,
            "ClientGetState": _ClientGetState,
            "ClientReceiveIncomingAudioStreamEvent": _ClientReceiveIncomingAudioStreamEvent,
            "ClientReceiveIncomingPersistenceMessage": _ClientReceiveIncomingPersistenceMessage,
            "ClientReceiveIncomingPersistenceMessageData": _ClientReceiveIncomingPersistenceMessageData,
            "ClientReceiveIncomingRPCMessage": _ClientReceiveIncomingRPCMessage,
            "ClientReceiveIncomingRPCMessageData": _ClientReceiveIncomingRPCMessageData,
            "ClientSendPersistenceMessage": _ClientSendPersistenceMessage,
            "ClientSendRPCMessage": _ClientSendRPCMessage,
            "ClientSetProfilingEnabled": _ClientSetProfilingEnabled,
            "ClientSetUpNetworkStack": _ClientSetUpNetworkStack,
            "ClientStartConnection": _ClientStartConnection,
            "ClientTearDownNetworkStack": _ClientTearDownNetworkStack,
            "ClientTryGetProfilingSample": _ClientTryGetProfilingSample,
            ...
            "MatcherClearRequest": _MatcherClearRequest,
            "MatcherConnect": _MatcherConnect,
            "MatcherConnectToRoom": _MatcherConnectToRoom,
            "MatcherCreate": _MatcherCreate,
            "MatcherDelete": _MatcherDelete,
            "MatcherDisconnect": _MatcherDisconnect,
            "MatcherGetConnectToRoomRequestClustersToPingAddressAtIndex": _MatcherGetConnectToRoomRequestClustersToPingAddressAtIndex,
            "MatcherGetConnectToRoomRequestClustersToPingCount": _MatcherGetConnectToRoomRequestClustersToPingCount,
            "MatcherGetConnectToRoomRequestClustersToPingNameAtIndex": _MatcherGetConnectToRoomRequestClustersToPingNameAtIndex,
            "MatcherGetConnectToRoomRequestFoundRoomResponse": _MatcherGetConnectToRoomRequestFoundRoomResponse,
            "MatcherGetConnectToRoomRequestResponseType": _MatcherGetConnectToRoomRequestResponseType,
            "MatcherGetRequestErrorMessage": _MatcherGetRequestErrorMessage,
            "MatcherGetRequestFailMessage": _MatcherGetRequestFailMessage,
            "MatcherGetRequestState": _MatcherGetRequestState,
            "MatcherTick": _MatcherTick,
            "MicrophoneCreate": _MicrophoneCreate,
            "MicrophoneDelete": _MicrophoneDelete,
            "MicrophoneGetAudioData": _MicrophoneGetAudioData,
            "MicrophoneGetChannels": _MicrophoneGetChannels,
            "MicrophoneGetSampleRate": _MicrophoneGetSampleRate,
            "MicrophonePlatformSupported": _MicrophonePlatformSupported,
            "MicrophoneStart": _MicrophoneStart,
            "MicrophoneStop": _MicrophoneStop,
            "SetLogFunction": _SetLogFunction,
