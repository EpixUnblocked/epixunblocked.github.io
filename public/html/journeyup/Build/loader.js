function createUnityInstance(t, n, d) {
    ...
    m.SystemInfo = function() {
        ...
        webgpuVersion = 0,
        (f = document.createElement("canvas")) && (u = (p = f.getContext("webgl2")) ? 2 : 0, p || (p = f && f.getContext("webgl")) && (u = 1), p && (o = p.getExtension("WEBGL_debug_renderer_info") && p.getParameter(37446) || p.getParameter(7937)), webgpuVersion = navigator.gpu ? 1 : 0);
